...
export const reducerUtils = {
  ...
  // 로딩중 상태, prevState의 경우엔 기본값은 null 이지만 따로 값을 지정하면 null 로 바꾸지 않고 다른 값을 유지시킬 수 있음
...
// type은 액션의 타입, key는 상태의 key (예: post, post)
/* API 재로딩 문제 해결 : 만약 데이터가 이미 존재한다면 요청을 하지 않기 - 수정 */
// 사용자에게 좋은 경험을 제공, 뒤로가기를 통해 다시 포스트 목록을 조회 할 때 최신 데이터를 보여줄 수 있음
...
/* 기존 함수를 수정하는 대신에 새로운 이름으로 다음 함수들을 작성 - createPromiseThunkById, handleAsyncActionsById */
